      ...
      <section className={styles.heroSection}>
        <div className={styles.container}>
          ...
          <div className={styles.heroImageWrapper}>
            <img src={bannerImage} alt="V Caps Rewards" className={styles.bannerImg} />
          </div>
        </div>
      </section>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.introText}>
            <p>
              ...
              Your loyalty translates into points, and your points open the door to exciting weekly draws and exclusive lifestyle rewards.
            </p>
          </div>
          ...
          <div className={styles.detailedContent}>
            ...
            <ul className={styles.list}>
              ...
              <li>1,000 V Caps and above = 4 tickets</li>
            </ul>
            <p className={styles.paragraph}>
